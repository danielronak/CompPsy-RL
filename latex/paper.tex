...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\linewidth]{figures/dose_response_ablation.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\linewidth]{figures/calibration_gap.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.62\textwidth]{figures/choice_overload_metrics.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\linewidth]{figures/shared_mechanism_staleness.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.56\textwidth]{figures/human_benchmarks_4panel.png}
...
\begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=0.82\linewidth]{figures/dqn_buffer_ablation.png}
...
\begin{subfigure}[b]{0.48\textwidth}
    \centering
    \includegraphics[width=0.82\linewidth]{figures/dqn_cognitive_dissonance.png}
