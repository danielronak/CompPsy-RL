...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{figures/handicap_penalty_sweep.png}
\caption{Self-handicapping dose-response. Impostor agents (orange) self-handicap far more than calibrated controls (green) at low penalties; both are suppressed as the objective penalty grows, yielding a genuine cost--benefit tradeoff rather than an unconditional bias.}
\label{fig:exp43_sweep}
\end{figure}
